...
# Comment everything from here if you are loading an already saved model
# *******************************************************
""" text_as_int = np.array([char2idx[c] for c in text])
seq_length = 100
...
EPOCHS = 50
#Probaj za test najprije pokrenuti s 1 epohom pa kada radi onda vrati na 50 epoha
#EPOCHS = 1
...
# *************************************
# Go here if you are loading a saved model
# And uncomment the next line to load the saved model
model = tf.keras.models.load_model('nas_model_stihovi.h5')
...
print(generate_text(model, start_string=u"Good morning my love",t=0.3))
